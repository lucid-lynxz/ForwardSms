 ...
 */
class CommonRoundOutlineProvider(
    var clipCircle: Boolean = false,
    var roundRadiusPx: Float = 10F
) : ViewOutlineProvider() {
...
fun String?.convertDateFormat(
    oriFormat: String = "yyyy-MM-dd'T'HH:mm:ss",
 ...
 * 当前系统api级别是否大于等于指定版本
 * */
fun Any?.isSdkGE(targetSdk: Int) = Build.VERSION.SDK_INT >= targetSdk
